...
DEMO_METADATA = {
    "categories": ["Industry"],
    "tags": ["Education", "Regulations", "University"]
}
...
if "FU_messages" not in st.session_state:
    st.session_state.FU_messages = []

# Display chat messages from history on app rerun
for message in st.session_state.FU_messages:
...
if prompt:
    ...
    st.session_state.FU_messages.append({"role": "user", "content": prompt})
    ...
    # Add assistant response to chat history
        st.session_state.FU_messages.append({"role": "assistant", "content": response})
